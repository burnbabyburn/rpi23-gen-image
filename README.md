...
|KERNEL_DEFAULT_GOV|string||`performance`\|`powersave`\|`userspace`\|`ondemand`\|`conservative`\|`schedutil`|Set the default cpu governor at kernel compilation. Possivle values: |
