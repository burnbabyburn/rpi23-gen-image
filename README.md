...
|HOSTNAME|string|RPI_MODEL-RELEASE(RPI3-buster)|SomeImageName|Set system hostname. It's recommended that the hostname is unique in the corresponding subnet.|
...
|KERNEL_DEFAULT_GOV|||Set the default cpu governor at kernel compilation. Possivle values: PERFORMANCE\|POWERSAVE\|USERSPACE\|ONDEMAND\|CONSERVATIVE\|SCHEDUTIL|ONDEMAND|
